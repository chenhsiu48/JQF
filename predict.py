...
if __name__ == '__main__':
    ...
    parser.add_argument('--qtable', default='./data/JQF-qtables-95.txt', type=str, help='optimized qtables')
    ...
    parser.add_argument('--quality', '-q', default=95, type=int, help='JPEG encoding quality metric')
